    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="edicaMainNav">
                <ul class="navbar-nav mx-auto mt-2 mt-lg-0 align-items-center">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="blogDropdown">
                            ...
                            <a class="dropdown-item" href="{{ route('post.category.index', $category->id) }}">{{ $category->title }}</a>
                            @endforeach
                        </div>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="blogDropdown">
                            @foreach($tags as $tag)
                                <a class="dropdown-item" href="{{ route('post.tag.index', $tag->id) }}">{{ $tag->title }}</a>
                            @endforeach
                        </div>
                    </li>
                    @guest()
                    ...
                    @auth()
                        ...
                        <li class="nav-item">
                            <form action="{{ route('logout') }}" method="post">
                                @csrf
                                <button type="submit" class="border-0 bg-transparent font-weight-bold">Logout</button>
                            </form>
                        </li>
                    @endauth
                </ul>
